package com.github.zaileitv.osc.ui.activity;
...
import com.github.zaileitv.osc.api.ApiConfig;
import com.github.zaileitv.osc.base.BaseActivity;
import com.github.zaileitv.osc.base.BaseLazyFragment;
import com.github.zaileitv.osc.bean.AbsSortXml;
import com.github.zaileitv.osc.bean.MovieSort;
import com.github.zaileitv.osc.event.RefreshEvent;
import com.github.zaileitv.osc.server.ControlManager;
import com.github.zaileitv.osc.ui.adapter.HomePageAdapter;
import com.github.zaileitv.osc.ui.adapter.SortAdapter;
import com.github.zaileitv.osc.ui.dialog.TipDialog;
import com.github.zaileitv.osc.ui.fragment.GridFragment;
import com.github.zaileitv.osc.ui.fragment.UserFragment;
import com.github.zaileitv.osc.ui.tv.widget.DefaultTransformer;
import com.github.zaileitv.osc.ui.tv.widget.FixedSpeedScroller;
import com.github.zaileitv.osc.ui.tv.widget.NoScrollViewPager;
import com.github.zaileitv.osc.ui.tv.widget.ViewObj;
import com.github.zaileitv.osc.util.AppManager;
import com.github.zaileitv.osc.util.DefaultConfig;
import com.github.zaileitv.osc.util.HawkConfig;
import com.github.zaileitv.osc.util.LOG;
import com.github.zaileitv.osc.viewmodel.SourceViewModel;
...
public class HomeActivity extends BaseActivity {
    ...
    private void exit() {
        if (System.currentTimeMillis() - mExitTime < 2000) {
            ...
            Toast.makeText(mContext, "再按一次离开【在类影视TV版】", Toast.LENGTH_SHORT).show();
        }
    }
